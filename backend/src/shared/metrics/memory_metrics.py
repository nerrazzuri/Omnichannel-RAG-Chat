...
class _MemoryMetrics:
    def __init__(self) -> None:
        ...
        self._pruned_total = Counter("ai_core_memory_pruned_total", "Memory turns pruned due to token budget", ["tenant"]) 
        self._summary_updates_total = Counter("ai_core_memory_summary_updates_total", "Rolling memory summary updates", ["tenant"]) 
        self._cleanup_sqlite_total = Counter("ai_core_memory_cleanup_sqlite_total", "SQLite cleanup deletions", ["tenant"]) 

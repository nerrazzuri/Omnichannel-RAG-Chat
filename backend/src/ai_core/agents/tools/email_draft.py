...
class EmailDraftTool:
    spec = ToolSpec(
        ...
        category="write",
        input_schema={"type": "object", "properties": {"to": {"type": "array"}, "cc": {"type": "array"}, "subject": {"type": "string"}, "body_markdown": {"type": "string"}}, "required": ["to", "subject", "body_markdown"]},
    ...
    def execute(self, *, tenant_id: str, api_key_id: Optional[str], payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {"status": "ok", "draft_id": "draft-" + (payload.get("subject") or "")[0:8]}

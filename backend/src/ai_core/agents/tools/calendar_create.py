...
class CalendarCreateTool:
    spec = ToolSpec(
        ...
        category="write",
        input_schema={"type": "object", "properties": {"title": {"type": "string"}, "start": {"type": "string"}, "end": {"type": "string"}, "attendees": {"type": "array"}, "location": {"type": "string"}, "description": {"type": "string"}}, "required": ["title", "start", "end"]},
    ...
    def execute(self, *, tenant_id: str, api_key_id: Optional[str], payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {"status": "ok", "event_id": "event-" + (payload.get("title") or "")[0:8]}

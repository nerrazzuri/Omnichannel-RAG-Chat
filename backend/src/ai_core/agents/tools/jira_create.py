...
class JiraCreateTool:
    spec = ToolSpec(
        ...
        category="write",
        input_schema={"type": "object", "properties": {"project": {"type": "string"}, "summary": {"type": "string"}, "description": {"type": "string"}, "assignee": {"type": "string"}, "priority": {"type": "string"}, "idempotency_key": {"type": "string"}}, "required": ["project", "summary"]},
    ...
    def execute(self, *, tenant_id: str, api_key_id: Optional[str], payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {"status": "ok", "issue_key": issue_key, "summary": payload.get("summary")}

...
class FileExportTool:
    spec = ToolSpec(
        ...
        category="write",
        input_schema={"type": "object", "properties": {"path": {"type": "string"}, "content": {"type": "string"}, "content_type": {"type": "string"}, "idempotency_key": {"type": "string"}}, "required": ["path", "content", "content_type"]},

...
class PipelineCache:
    ...
    def get(self, tenant_id: str, scope: str, query: str) -> Optional[Any]:
        try:
            ...
            logger.exception("[pipeline_cache.get] error", extra={"tenant_id": tenant_id, "scope": scope})
            return None
    ...
    def set(self, tenant_id: str, scope: str, query: str, value: Any, ttl: int = 600) -> None:
        try:
            ...
            import logging
            logger = logging.getLogger(__name__)
            logger.exception("[pipeline_cache.set] error", extra={"tenant_id": tenant_id, "scope": scope})

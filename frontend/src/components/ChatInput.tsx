    ...
    <div className="flex items-end gap-2">
      ...
      >
        <svg
          ...
          fill="currentColor"
        >
          <path d="M8 6a4 4 0 0 1 8 0v8a3 3 0 1 1-6 0V8a1 1 0 0 1 2 0v7a1 1 0 0 0 2 0V6a2 2 0 1 0-4 0v9a4 4 0 0 0 8 0V8a1 1 0 1 1 2 0v7a6 6 0 1 1-12 0V8A4 4 0 0 1 8 6z" />
        </svg>
      </button>
      <textarea
        rows={1}

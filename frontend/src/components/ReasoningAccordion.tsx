        ...
        <div className="p-4 bg-white space-y-4">
          <div className="flex items-start gap-2 rounded border border-amber-200 bg-amber-50 text-amber-900 p-3 text-xs">
            ...
            >
              <path
                fillRule="evenodd"
                d="M8.257 3.099c.765-1.36 2.72-1.36 3.485 0l6.518 11.6A2 2 0 0 1 16.518 18H3.482a2 2 0 0 1-1.742-3.3l6.517-11.6zM11 13a1 1 0 1 0-2 0v1a1 1 0 0 0 2 0v-1zm-1-2a1 1 0 0 0 1-1V7a1 1 0 1 0-2 0v3a1 1 0 0 0 1 1z"
                clipRule="evenodd"
              />
            </svg>
            <p>
              This is a high‑level supporting explanation of how the answer was
              assembled. It is not raw model chain‑of‑thought and may be
              imperfect—verify critical steps.
            </p>
          </div>
